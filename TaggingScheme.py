...
import numpy as np
def get_val(file0,testfile,valfile):
    f=open(file0,'r')
    tf=open(testfile,'w')
    vf=open(valfile,'w')
    fr=f.readlines()
    rand=np.random.permutation(len(fr))
    fvf=rand[:len(rand)//10]
    ftf=rand[len(rand)//10:]
...
#    infile4 = "./data/demo/test_tag.json"
    ...
    infile1 = "./data/NYT_new/raw_train.json"
    infile2 = "./data/NYT_new/train_tag.json"
    infile3 = "./data/NYT_new/raw_test.json"
    infile4 = "./data/NYT_new/test_tag.json"
    tag_sent(infile1,infile2,isTrain=True)
    tag_sent(infile3,infile4,isTrain=False)

    infile1 = "./data/WEB_new/train_nlg.json"
    infile2 = "./data/WEB_new/train_tag.json"
    infile3 = "./data/WEB_new/test_nlg.json"
    infile4 = "./data/WEB_new/test_tag.json"
    tag_sent(infile1,infile2,isTrain=True)
    tag_sent(infile3,infile4,isTrain=False)
    
    infile1 = "./data/KBP_new/raw_train_kbp.json"
    infile2 = "./data/KBP_new/train_tag.json"
    infile3 = "./data/KBP_new/raw_test_kbp.json"
    infile4 = "./data/KBP_new/test_tag.json"
    tag_sent(infile1,infile2,isTrain=True)
    tag_sent(infile3,infile4,isTrain=False)


#    tag=['sent':"a b c d e f g h i j k "
#            ]
